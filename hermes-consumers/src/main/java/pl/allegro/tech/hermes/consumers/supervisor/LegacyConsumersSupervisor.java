...
public class LegacyConsumersSupervisor implements ConsumersSupervisor {


    private static final Logger logger = LoggerFactory.getLogger(LegacyConsumersSupervisor.class);
    ...
    @Inject
    public LegacyConsumersSupervisor(ConfigFactory configFactory,
